...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name:str, decode:bool = True, make_readable:bool = False)-> Union[str, StringIO]:
        """
        ...
        """
        logging.info("Entered read_object method of SimpleStorageClass")
        try: 
            func = (
    ...
    def get_bucket(self, bucket_name:str)-> Bucket:
        ...
        """
        try:
            logging.info("Entered the get_bucket method of SimpleStorageClass")
            bucket = self.s3_resource.Bucket(bucket_name)
            logging.info("Exited the get_bucket method of SimpleStorageClass")
            return bucket
        except Exception as e:
            raise MyException(e,sys) from e
    ...
    def get_file_object(self, filename:str, bucket_name:str)-> Union[List[object],object]:
        ...
        try:
            logging.info("Entered the get_file_object method of SimpleStorageClass")
            bucket = self.get_bucket(bucket_name)
            file_objects = [file_obj for file_obj in bucket.objects.filter(Prefix=filename)]
            func = lambda x: x[0] if len(x)==1 else x
            file_objs = func(file_objects)
            logging.info("Exited the get_file_object method of SimpleStorageClass")
            return file_objs
        except Exception as e:
            raise MyException(e,sys) from e
    ...
    def load_model(self, model_name:str, model_dir:str, bucket_name:str=None)->object:
        ...
        """
        try: 
            logging.info("Entered load_model method of SimpleStorageService Class")
    ...
    def create_folder(self, folder_name:str, bucket_name:str)->None:
        ...
        Args:
            ...
            bucket_name (str): Name of the S3 bucket.
        """
        logging.info("Entered create_folder method of SimpleStorageService Class")
        try:
            ...
            logging.info("Exited create_folder method of SimpleStorageService Class")
    ...
    def upload_file(self, from_filename:str, to_filename:str, bucket_name:str, remove:bool=True)->None:
        ...
        logging.info("Entered upload_file method of SimpleStorageService Class")
        try:
    ...
    def upload_df_as_csv(self, bucket_name:str, bucket_filename:str, data_frame:DataFrame, local_filename:str)->None:
        """
        ...
        try: 
            ...
            logging.info("Exited upload_file method of SimpleStorageService Class")
